...
class ScreenIO:
    ...
    @staticmethod
    def print_menu():
        """MAIN MENU Displays a menu of choices to the user
    ...
    def menu_choice():
        ...
        """
        choice = ' '
        while choice not in ['l', 'a', 'd', 'c', 's', 'x', 't']:
    ...
    @staticmethod
    def print_CD_menu():
        """CD MENU Displays a sub menu of choices for CD / Album to the user
        ...
        print('CD Sub Menu,\n')
        print('[a] Add track')
        print('[d] Display cd / Album details')
    ...
    def get_CD_info():
        ...
        while cdId == '':
            ...
            try:
                ...
                print('More details than you want or need:' + str (e) )
                cdId = ''
    ...
    def get_track_info():
        ...
        Returns:
            trkId (string): Holds the ID of the Track dataset. #String? convert here or elsewhere?
