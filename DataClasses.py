...
# TMcFarland, 2021-Mar-16, Rough Code entry
#------------------------------------------#
...
class Track():
    ...
    def __init__(self, pos: int, ttl: str, lgth: str) -> None:
        """Set Track Position, Track Title and Track Length for a specific track"""
        # -- Attributes -- #
        try:
            ...
            raise Exception('Error setting Values. Track Position should be an integer, everything else is a string\n' + str (e))
    ...
    def title(self, value):
        try:
            ...
            raise Exception('Track Position needs to be a String')
    ...
    def __str__(self):
        ...
        return '{}\t{}\t (trt:  {})'.format(self.position, self.title, self.length)
